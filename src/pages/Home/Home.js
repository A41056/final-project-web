...
export const Home = () => {
    ...
    const transformProductData = (products) => {
        ...
        return products.map((p) => {
            ...
            const discountPriceRange = discountPrices.length > 1
